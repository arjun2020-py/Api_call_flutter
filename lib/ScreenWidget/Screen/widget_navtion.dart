...
import 'api_search_bar.dart';
import 'bottom_navigation_demo.dart';
import 'data_tabel_screen.dart';
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              ButtonWidget(
                text: 'DataTabel',
                color: Color.fromARGB(255, 13, 86, 159),
                onTap: () {
                  Get.to(DataTabelScreen());
                },
              ),
              ButtonWidget(
                text: 'Api search',
                color: Color.fromARGB(255, 188, 148, 148),
                onTap: () => Get.to(ApiSearchbar()),
              )
            ],
          ),
        ),
